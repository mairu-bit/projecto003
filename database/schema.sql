...
INSERT INTO courses (spec_no, title, description, icon_svg, max_seats, start_date, end_date, sort_order) VALUES
('SPEC · 01', 'เครื่องยนต์แก๊สโซลีน',
 'โครงสร้าง การทำงาน และการซ่อมบำรุงเครื่องยนต์เบนซินตั้งแต่พื้นฐานถึงขั้นวิเคราะห์ปัญหา',
 '<rect x="16" y="10" width="16" height="14" rx="2"/><path d="M20 24v6M28 24v6"/><rect x="17" y="30" width="14" height="4" rx="1"/><path d="M24 34v6"/><circle cx="24" cy="40" r="4"/>', 30, '2026-05-15', '2026-09-30', 1),
('SPEC · 02', 'เครื่องยนต์ดีเซล',
 'ระบบฉีดเชื้อเพลิง แรงอัด และการบำรุงรักษาเครื่องยนต์ดีเซลที่ใช้ในยานยนต์และเครื่องจักรกล',
 '<path d="M18 8h6l2 6h-10z"/><path d="M20 14v6"/><rect x="12" y="20" width="16" height="18" rx="2"/><path d="M16 26h8M16 31h8"/>', 25, '2026-05-15', '2026-09-30', 2),
('SPEC · 03', 'ระบบไฟฟ้ายานยนต์',
 'วงจรไฟฟ้ารถยนต์ แบตเตอรี่ ระบบสตาร์ท-ชาร์จ และการวินิจฉัยด้วยเครื่องมือวัดสมัยใหม่',
 '<path d="M26 6 14 26h8l-2 16 14-22h-8z" stroke-linejoin="round"/>', 20, '2026-06-01', '2026-10-15', 3),
('SPEC · 04', 'ระบบส่งกำลังและช่วงล่าง',
 'คลัตช์ เกียร์ เพลาขับ ระบบเบรกและช่วงล่าง ทั้งภาคทฤษฎีและการถอด-ประกอบจริง',
 '<circle cx="18" cy="30" r="6"/><circle cx="34" cy="18" r="4"/><path d="M22 26l8-6M22 33l14 3"/>', 25, '2026-06-01', '2026-10-15', 4);
...
('admin', '$2b$10$8GO08IUYj0LFxqh5m1ppIOvxKU5aryzMl2/Fx7eBQ2pEBt/pm.wNa', 'admin', 'ผู้ดูแลระบบ');
